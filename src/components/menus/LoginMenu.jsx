    ...
    <div className="w-full max-w-[22rem] h-fit rounded-lg flex flex-col items-center overflow-hidden bg-base-100 transition-all p-4 gap-4">
      ...
      <div className="flex flex-col w-full items-center gap-2">
        ...
        <LoginButton
          onClick={() => loginGoogle()}
          Icon={
            <div className="rounded-full p-1.5 bg-white -m-1.5">
              <FcGoogle size={20} />
            </div>
          }
          style={{
...
export function LoginButton({
  ...
  return (
    <button
      ...
      style={style}
      className={
        "clickable px-4 py-2 text-xl font-extrabold cursor-pointer flex flex-row items-center justify-start w-full rounded-md gap-4 " +
        " " +
        style
      }
    >
