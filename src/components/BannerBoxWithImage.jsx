...
function BannerBoxWithImage({ src, children, href, noTarget = false }) {
  return (
    <a
      ...
      className=" px-4 w-full flex items-center justify-center clickable"
    >
      <div className="border-2 border-neutral flex items-center w-full max-w-2xl p-2 gap-2 rounded-xl h-20 ">
