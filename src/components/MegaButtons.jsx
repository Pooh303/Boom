  ...
  return (
    <>
      <button
        ...
        title={title}
        className={
          "rounded-md w-fit tooltip clickable group  " +
      ...
      >
        <div
          ...
          className={
            "text-md h-14 tracking-tighter   rounded-md px-4 min-w-[2rem] py-2 flex items-center justify-center font-extrabold gap-3 " +
            (fill ? " w-full " : " w-fit ")
          }
        >
          {Icon && (
...
export function BookmarkMegaButton({
  bookmarked = false,
  onChange = () => {},
}) {
  ...
  return (
    <MegaButton
      ...
      fill
      color={"#72c4ff"}
      onClick={() => checkAuth(() => handleChange())}
    >
...
export function EditPlaysetButton({ onClick = () => {} }) {
  ...
  return (
    <MegaButton
      title="Edit"
      Icon={<BsPencilFill className="text-lg" />}
      fill
      color="#7e22ce"
      onClick={() => checkAuth(() => onClick())}
    >
...
export function BigAbsoluteMakeButton({ onClick = () => {} }) {
  ...
  return (
    <MegaButton
      ...
      color={"#fc021b"}
      className={" drop-shadow-2xl fixed bottom-4 right-4 z-10"}
      onClick={() => checkAuth(() => onClick())}
    >
