...
function ContributeLinks(props) {
    return (
        <div className="w-full flex flex-col items-center max-w-md gap-2 px-10 my-4">
            ...
            <Link className="bg-[#1b1f23] border-4 border-[#1b1f23] text-white font-bold text-2xl " src="/github.png" href="https://github.com/Pooh303">
                GitHub
            </Link>
            <Link className="bg-[#5562ea] border-4 border-[#5562ea] p-0.5 pl-2.5" src="/discordbanner.png" href="https://discord.gg/4XgRh5N5Uc">
