...
function PlayerNumberFilter({
  ...
  return (
    <div
      className={
        "bg-base-100 w-full p-4 flex flex-col items-start justify-center gap-4 rounded-lg"
      }
    >
      ...
      <div className="w-full flex items-center justify-end gap-2">
        <button
          ...
          className={
            ...
            (!currentValue ? " btn-disabled " : " ")
          }
        >
          Clear
        </button>
        <button
          onClick={() => onChange(parseInt(number))}
