...
const CONFLICTS = [["verified", "official", "dev"]];
  ...
  return (
    <div className="w-full flex items-center gap-2 h-14">
      <FilterToggleWrapper
        ...
        handleClick={handleBooleanClick}
      >
        <VscVerifiedFilled />
      </FilterToggleWrapper>
      ...
      <FilterToggleWrapper
        ...
        color="#ff0000"
        activeToggles={activeToggles}
        handleClick={openUserFilterMenu}
      >
        <HiUsers />
        {activeToggles.playerNumber ? (
          <div className="text-xl ml-2 font-extrabold">
            {activeToggles.playerNumber}
          </div>
        ) : null}
      </FilterToggleWrapper>
...
function FilterToggleWrapper(props) {
  ...
  return (
    <div
      ...
      className={
        "text-2xl clickable flex items-center justify-center bg-base-200/50 border-2 h-14 min-w-14 rounded-lg "
      }
    >
      <div
        className={
          "w-full h-full flex items-center justify-center px-3.5" +
          (isActive
