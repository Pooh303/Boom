...
export function Tab({
  ...
  // data will be sent back onClick (if no data then title will be sent)
  return (
    <div
      ...
      style={{
        backgroundColor: selected
          ? color
            ...
            : "#dedede"
          : "#dedede",
        color: selected ? (color ? color : "black") : "#000000",
        borderColor: selected ? (color ? color : "black") : "#dedede",
      }}
      className={
        " whitespace-nowrap rounded-full h-8 py-0.5 px-5 font-semibold flex items-center justify-center transition-all border-2 " +
        (selected ? "  " : "  ")
      }
    >
      {title}
