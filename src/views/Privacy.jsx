...
function Privacy(props) {
  return (
    <div className="absolute inset-0 p-4 overflow-y-scroll">
      <h1 className="text-xl font-extrabold">Privacy Policy for Kaboom</h1>

      <p>
        At Kaboom, accessible from https://playkaboom.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Kaboom
        and how we use it.
      </p>
      ...
      <p>
        Kaboom follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Kaboom uses "cookies". These cookies are used to
      ...
      <p>
        ...
        advertising partners of Kaboom.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Kaboom, which are sent directly
      ...
      <p>
        Note that Kaboom has no access to or control over these cookies that are
      ...
      <p>
        Kaboom's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Kaboom does not knowingly collect any Personal Identifiable Information
      ...
      <p>
        ...
        shared and/or collect in Kaboom. This policy is not applicable to any
